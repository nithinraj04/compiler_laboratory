...
static const char *const yytname[] =
{
  ...
  "WRITE", "NUM", "ID", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "';'",
  "'='", "$accept", "start", "stmtList", "stmt", "inputStmt", "outputStmt",
...
{
       5,    24,    20,   -16,    18,    23,   -11,    29,   -16,   -16,
     -16,   -16,   -16,    32,     2,     2,   -16,   -16,    12,   -16,
     -16,     2,     7,    -8,    26,    13,     2,     2,     2,     2,
      28,   -16,   -16,   -16,    27,    27,   -16,   -16,   -16
};
...
{
      23,    26,    27,    28,    29,    15,    25,    31,     1,    19,
      20,    34,    35,    36,    37,    21,    26,    27,    28,    29,
      12,    30,    26,    27,    28,    29,    24,    33,     3,     4,
       5,    13,     6,    16,     4,     5,    14,     6,    28,    29,
      18,    32,    17,    38
};

static const yytype_int8 yycheck[] =
{
      15,     9,    10,    11,    12,    16,    21,    15,     3,     7,
       8,    26,    27,    28,    29,    13,     9,    10,    11,    12,
       0,    14,     9,    10,    11,    12,    14,    14,     4,     5,
       6,    13,     8,     4,     5,     6,    13,     8,    11,    12,
       8,    15,     7,    15
};
...
static const yytype_int8 yystos[] =
{
      ...
      22,    23,     0,    13,    13,    16,     4,    20,     8,     7,
       8,    13,    24,    24,    14,    24,     9,    10,    11,    12,
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: START stmtList END  */
#line 29 "parse.y"
                             { root = (yyvsp[-1].p); }
#line 1375 "parse.tab.c"
    break;

  case 3: /* start: START END  */
#line 30 "parse.y"
                             { root = NULL; }
...
#line 32 "parse.y"
                             { (yyval.p) = makeConnectorNode((yyvsp[-1].p), (yyvsp[0].p)); }
...
#line 39 "parse.y"
                                   { (yyval.p) = makeReadNode((yyvsp[-2].p)); }
#line 1417 "parse.tab.c"
    break;

  case 10: /* outputStmt: WRITE '(' expr ')' ';'  */
#line 41 "parse.y"
                                    { (yyval.p) = makeWriteNode((yyvsp[-2].p)); }
#line 1423 "parse.tab.c"
    break;

  case 11: /* assignStmt: ID '=' expr ';'  */
#line 43 "parse.y"
                                    { (yyval.p) = makeOpNode('=', (yyvsp[-3].p), (yyvsp[-1].p)); }
#line 1429 "parse.tab.c"
    break;

  case 12: /* expr: expr '+' expr  */
#line 45 "parse.y"
                             { (yyval.p) = makeOpNode('+', (yyvsp[-2].p), (yyvsp[0].p)); }
